<div align="center">
  ...
  <a class="header-badge" target="_blank" href="https://twitter.com/aliyan-shaikh66">
  <img alt="Twitter Follow" src="https://img.shields.io/twitter/follow/aliyan-shaikh66?style=social">
  </a>

<sub>Author:
<a href="https://www.linkedin.com/in/aliyan-shaikh66/" target="_blank">aliyan-shaikh66 Shaikh</a><br>
...
print(greetings('aliyan-shaikh66'))
...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('aliyan-shaikh66','Shaikh'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'aliyan-shaikh66', lastname = 'Shaikh'))
...
def print_name(firstname):
    return firstname
print_name('aliyan-shaikh66') # aliyan-shaikh66

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='aliyan-shaikh66', lastname='Shaikh')
```
...
def generate_full_name (first_name = 'aliyan-shaikh66', last_name = 'Shaikh'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
print(generate_groups('Team-1','aliyan-shaikh66','Brook','David','Eyob'))
```
