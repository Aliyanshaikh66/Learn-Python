...
```py
 lst = ['Aliyan', 250, True, {'country':'Finland', 'city':'Helsinki'}] # list containing different data types
```
...
1. Find the middle country(ies) in the [countries list](https://github.com/Aliyanshaikh66)
