<div align="center">
  ...
  <a class="header-badge" target="_blank" href="https://www.linkedin.com/in/aliyanshaikh/">
...
# main.py file
import mymodule
print(mymodule.generate_full_name('aliyanshaikh', '66')) # aliyanshaikh 66
```
...
print(generate_full_name('Asabneh','66'))
...
```sh
python script.py aliyanshaikh 30DaysOfPython
```

The result:

```sh
Welcome aliyanshaikh. Enjoy  30DayOfPython challenge! 
```
